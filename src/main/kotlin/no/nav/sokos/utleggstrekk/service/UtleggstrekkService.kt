...
class UtleggstrekkService(
    ...
    suspend fun behandleUtleggstrekk(): List<Utleggstrekk> {
        ...
        val genererteTrekk = genererTrekkService.lagTrekkTilOs(trekkListeFraDb)
    ...
    private fun lagreAlleNyeUtleggstrekk(trekkListe: List<Utleggstrekk>): List<Utleggstrekk> =
        trekkListe
            ...
            .also { println("Etter filtrering av de vi har fra før : ${it.size}") }
            .also { databaseService.lagreAlleNyeUtleggstrekk(it) }
}