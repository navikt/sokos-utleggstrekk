...
envValue=$(kubectl exec -it $(kubectl get pods | grep sokos-utleggstrekk | cut -f1 -d' ') -c sokos-utleggstrekk -- env | egrep "^AZURE|^MASKINPORTEN|^MQ_|^POSTGRES|^SOKOS_UTLEGGSTREKK"| sort)
